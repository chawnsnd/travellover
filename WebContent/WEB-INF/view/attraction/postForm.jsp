    ...
    <div class="main_container">
      ...
      <form method="post" action="/attraction/post.do" enctype="multipart/form-data">
        ...
        <div class="right">
          ...
          <div class="input_form">
          <span class="input_title">주소</span><input type="button" onclick="daumPostcode()" value="우편번호 찾기">
			<div><textarea style="margin-left: 100px" type="text" id="address" name="address" placeholder="도로명주소" row="3"></textarea></div>
          </div>
          <div class="input_form">
