        ...
        <div class="main_container" id="login">
                ...
                <div class="form">
	               <form method="post" action="/join.do">
	                   <div>이메일</div>
	                   <input type="email" id="email" name="email" class="inputbox"><div id="email_check" class="check"></div>
	                   <div>닉네임</div>
	                   <input type="text" id="nickname" name="nickname" class="inputbox"><div id="nickname_check" class="check"></div>
	                   <div>비밀번호</div>
	                   <input type="password" id="password" name="password" class="inputbox">
	                   <div>비밀번호확인</div>
	                   <input type="password" id="password2" name="confirmPassword" class="inputbox"><div id="password_check" class="check"></div>
	                   <div>
